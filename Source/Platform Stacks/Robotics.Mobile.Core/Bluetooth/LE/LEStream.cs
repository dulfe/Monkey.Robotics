...
namespace Robotics.Mobile.Core.Bluetooth.LE
{
    public class LEStream : Stream
    {
        ...
        // Services and Characteristics of HM10
        ...
        static readonly Guid TransmitCharId = new Guid("0000ffe1-0000-1000-8000-00805f9b34fb");
        static readonly Guid ResetCharId = new Guid("0000ffe1-0000-1000-8000-00805f9b34fb");
        ...
        async Task InitializeAsync()
        {
            try
            {
                Debug.WriteLine("LEStream: Looking for service " + ServiceId.ToString() + "...");
                service = await device.GetServiceAsync(ServiceId);
                Debug.WriteLine("LEStream: Got service: " + service.ID.ToString());
